...
=begin
  ...
  inflect.irregular "opcion_ca", "opcion_cas"
  inflect.irregular "datos_api", "datos_apis"
  inflect.irregular "datos_externo", "datos_externos"
  inflect.irregular "empresa", "empresa"
  ...
  # SINGULARES
  inflect.singular "menu", "menu"
  inflect.singular "persona", "persona"
  inflect.singular "rol", "rol"  
  inflect.singular "opcion", "opcion"
  inflect.singular "menu_rol", "menu_rol"
  inflect.singular "atributo", "atributo"
  inflect.singular "componente", "componente"
  inflect.singular "opcion_ca", "opcion_ca"
  inflect.singular "datos_api", "datos_api"
  inflect.singular "datos_externo", "datos_externo"
  inflect.singular "empresa", "empresa"
  inflect.singular "area", "area"
  inflect.singular "personas_area", "personas_area"
  inflect.singular "persona_empresa_formulario", "persona_empresa_formulario"
  ...
  inflect.plural "datos_api", "datos_apis"
  inflect.plural "datos_externo", "datos_externos"
