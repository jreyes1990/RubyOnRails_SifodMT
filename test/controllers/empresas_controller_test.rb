...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { descripcion: @empresa.descripcion, nombre: @empresa.nombre } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { descripcion: @empresa.descripcion, nombre: @empresa.nombre } }
