...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { descripcion: @area.descripcion, empresa_id: @area.empresa_id, nombre: @area.nombre } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { descripcion: @area.descripcion, empresa_id: @area.empresa_id, nombre: @area.nombre } }
